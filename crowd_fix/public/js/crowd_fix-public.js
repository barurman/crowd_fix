jQuery(document).ready(function ($) {
    ...
    // var string_login;
    //
    // string_login = ($('.woocommerce-info').text().indexOf('Please logged in first') > -1)  ? $('.woocommerce-info').html('Впервые на сайте? <a class="wpneoShowLogin" href="#">Регистрация</a>') : console.log('false') ;
